...
function _update_ps1() {
    PS1="(ROS-TOOLS)$(/usr/local/bin/powerline-go -error $? -modules "venv,user,cwd,perms,git,exit,root")"
}
...
# Define ROS2 discovery server and port with default values if not set
